...
Qubes OS calls virtual machines (VMs): Qube.
...
1. Open a terminal for Whonix-gateway (whonix-gw) or Whonix-workstation (whonix-ws).
2. Upgrade: `upgrade-nonroot`
...
`sudo qubes-dom0-update --enablerepo=qubes-templates-community --action=erase qubes-template-whonix-gw-16`


Whonix-Workstation `@Dom0`:

`sudo qubes-dom0-update --enablerepo=qubes-templates-community --action=erase qubes-template-whonix-ws-16`
